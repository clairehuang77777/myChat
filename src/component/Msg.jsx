    ...
    <div className={isSystemMsg ?
     ...
     <div className={isSystemMsg ? "left-msg-leftImgArea flex flex-row items-start p-3 hidden":"left-msg-leftImgArea flex flex-row items-start p-3"}>
      ...
      <div className="left-msg-rightTextArea flex flex-col pt-3">
        ...
        <div className={isSystemMsg ?
        "right-msg-rightTextArea-top-text w-fit ml-2 max-w-lg bg-[#9e9e9e] p-3 rounded-lg text-lg text-right text-white":
        rightSideOn ? 
        "right-msg-rightTextArea-top-text w-fit ml-2 max-w-sm bg-[#f9f9f9] p-3 rounded-lg text-lg text-right" : "left-msg-rightTextArea-top-text w-fit ml-2 max-w-sm bg-[#f9f9f9] p-3 rounded-lg text-lg text-left"}>{useImage ? (<img src={msg.message}></img>):(<p>{msg.message}</p>)}</div>
